...
export default {
  ...
  beforeCreate() {
    ...
    var isLessIE11 = userAgent.indexOf("Chrome") <= -1 && userAgent.indexOf("Safari") <= -1 && userAgent.indexOf("Opera") <= -1;
    if (isLessIE11) {
      alert('请升级至最新浏览器，若浏览器为360或百度或QQ浏览器，浏览模式改为急速模式,您的浏览器不能正常使用这个程序！')
      return
    }
  },
  created() {
